        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Fisioterapeuta</label>
                <select
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Sintomas ou Observações</label>
              <textarea
                name="symptoms"
            ...
            <div className="flex justify-end">
              <Link to="/dashboard" className="mr-4 px-4 py-2 border border-gray-300 rounded text-gray-700 hover:bg-gray-50">
                Cancelar
              </Link>
              <button
                type="submit"
